...
| **1140** | **C037 / C043** | Differences between C043 and C044 remain unclear. | Overall stable. Quiet fan behavior in Bypass/NoBatt mode. See also [here](https://github.com/Mights001/DeyeFirmware/wiki/11-%E2%80%90-3PH-LV-Inverter-Controller#mcu2_sg12klp3-v200x-1140-0824bin) | Keep if running stable | Factory default on some units |
...
| **1151** | **C04D** | max. Solar sell was limited to 12KW | **AC-Couple & GEN-Port:** Limits power to **2x nominal inverter rating**. See also [here](https://github.com/Mights001/DeyeFirmware/wiki/11-%E2%80%90-3PH-LV-Inverter-Controller#mcu2_sg12klp3-v200x-1151-1220bin) | Monitor community feedback | User tested / Official Deye DE release |
| **1170** | — | A possible [12-kW-Limit-Bug](https://dy-support.org/community/postid/24979/) | See also [here](https://github.com/Mights001/DeyeFirmware/wiki/11-%E2%80%90-3PH-LV-Inverter-Controller#mcu2_sg12klp3-v200x-1170-0322bin) | — | — |
| **1172** | **C050** | **Zero Export Bug** reported on some setups. **Poor/sluggish regulation** when using "MI Input", "AC Couple on Grid Side", or "AC Couple on Load Side". | 1172/C050 combination described positively by some users without AC Coupling; | Test Zero Export / AC-Couple behavior if installed | Mixed reports / Reportedly recalled initially |
| **1175** | **C070 / C071** | — | **Rock-solid release.** Considered stable benchmark. Required for LoRa Wallbox. Supports AC-couple via Meter2 while keeping GEN port free for a diesel generator (stable operation without power/signal fluctuations). See also [here](https://github.com/Mights001/DeyeFirmware/wiki/11-%E2%80%90-3PH-LV-Inverter-Controller#mcu2_sg12klp3-v200x-1175-1127bin) | **Highly Recommended** | Factory installed on newer units / Confirmed stable |
...
Additional infos you may find in the [LV MCU Wiki](https://github.com/Mights001/DeyeFirmware/wiki/11-%E2%80%90-3PH-LV-Inverter-Controller) or the [HMI/MCU Bundles Wiki](https://github.com/Mights001/DeyeFirmware/wiki/10-%E2%80%90-3PH-LV-Inverters-Bundles-(HMI---Controller))

### LV HMI Versions — Known infos
| HMI Version | Known Issues & Bugs | Characteristics & Capabilities | Recommended Action | Status & Notes |
| :--- | :--- | :--- | :--- | :--- |
| **C037** | — | Highly popular and reliable baseline HMI. Widely used in combination with multiple stable MCUs (1135, 1140, 1144). | Recommended baseline HMI. To be used if no newer features are needed | Community favorite / Confirmed stable |
...
| **C051** | Lacks LoRa support. | Good alternative build; works well in combination with MCU 1175. | Good pair for MCU 1175 | Plausible |
| **C057** | — | Delivered stock / factory default together with MCU 1172. | — | Factory default build |
...
| **C070** | Does not allow setting negative values. **No internal inverter statistics maintained/logged.** | Prerequisite for SmartTX / LoRa Wallbox app setup. | Upgrade to C071 if negative values or statistics are required | Confirmed |
| **C071** | — | **Solid HMI.** Runs reliably and stable. Prerequisite for SmartTX / LoRa Wallbox. | **Recommended HMI version** | Confirmed stable |
| **C072** | Associated with configuration loss issues when paired with MCU 118x. | — | Avoid when running MCU 118x | Confirmed |

Additional info you may find in the [LV HMI Wiki](https://github.com/Mights001/DeyeFirmware/wiki/30-%E2%80%90-3PH-LV-Inverters-HMI)
